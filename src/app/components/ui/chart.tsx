...
//                           indicator === "dashed" && "h-px w-4 border-dashed"
//                         )}
//                         style={{
...
//                     )
//                   )}
//                   <div className="flex-1 text-right text-xs [&>svg]:h-2.5 [&>svg]:w-2.5">
...
export const useChart = () => {
  throw new Error("Chart component is temporarily disabled");
};
